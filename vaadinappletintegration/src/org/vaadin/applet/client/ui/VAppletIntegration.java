...
public class VAppletIntegration extends HTML implements Paintable {
    ...
    public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
        ...
        if (!appletInitialized) {
            ...
            if (uidl.hasAttribute(ATTR_APPLET_WIDTH)) {
                setWidth(uidl.getStringAttribute(ATTR_APPLET_WIDTH));
            } else {
                setWidth("0");
            }

            if (uidl.hasAttribute(ATTR_APPLET_HEIGHT)) {
                setHeight(uidl.getStringAttribute(ATTR_APPLET_HEIGHT));
            } else {
                setHeight("0");
            }
